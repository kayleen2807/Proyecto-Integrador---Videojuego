...
def inicio():
    ...
    while True:
        ...
        boton_empezar = Button(image=pygame.image.load("assets/empezar.png"), image_hover=pygame.image.load("assets/empezar_h.png"), pos=(650, 400), text_input=".", font=get_font(1), base_color="Black", hovering_color="Grey")
